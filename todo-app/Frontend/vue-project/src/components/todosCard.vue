...
<template>
  <div
    class="[&::-webkit-scrollbar-track]:bg-jungle-green-800/50 [&::-discwebkit-scrollbar-thumb]:bg-jungle-green-900 max-h-100 w-full overflow-y-auto bg-amber-300 pr-2 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-2xl [&::-webkit-scrollbar-track]:rounded-2xl"
  >
    <div
      for="myCB"
